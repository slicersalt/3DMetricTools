/*=========================================================================
  ...
  Module:    vtkImplicitPolyDataDistance_m.cxx
...
vtkStandardNewMacro(vtkImplicitPolyDataDistance_m);

//-----------------------------------------------------------------------------
vtkImplicitPolyDataDistance_m::vtkImplicitPolyDataDistance_m()
{
  this->NoValue = 0.0;
...
//-----------------------------------------------------------------------------
void vtkImplicitPolyDataDistance_m::SetInput(vtkPolyData* input)
{
  if ( this->Input != input )
    {
...
//-----------------------------------------------------------------------------
double vtkImplicitPolyDataDistance_m::EvaluateFunction(double x[3], double *p_save )
{
  double n[3];
  return this->SharedEvaluate(x, n , p_save); // get distance value returned, normal not used
}

//-----------------------------------------------------------------------------
double vtkImplicitPolyDataDistance_m::EvaluateFunction(double x[3] )
{
  double n[3];
...
//-----------------------------------------------------------------------------
void vtkImplicitPolyDataDistance_m::EvaluateGradient(double x[3], double n[3])
{
  this->SharedEvaluate(x, n);	// get normal, returned distance value not used
}

//-----------------------------------------------------------------------------
double vtkImplicitPolyDataDistance_m::SharedEvaluate(double x[3], double n[3] , double *p_save )
{
...
//-----------------------------------------------------------------------------
void vtkImplicitPolyDataDistance_m::PrintSelf(ostream& os, vtkIndent indent)
{
