...
if((NOT DEFINED VTK_DIR OR NOT DEFINED VTK_SOURCE_DIR) AND NOT ${SUPERBUILD_TOPLEVEL_PROJECT}_USE_SYSTEM_${proj})
  ...
  if(3DMetricTools_QT_VERSION VERSION_LESS "5")
    set(3DMetricTools_VTK_RENDERING_BACKEND "OpenGL")
    list(APPEND EXTERNAL_PROJECT_OPTIONAL_CMAKE_CACHE_ARGS
    ...
    set(3DMetricTools_VTK_RENDERING_BACKEND "OpenGL2")
    list(APPEND EXTERNAL_PROJECT_OPTIONAL_CMAKE_CACHE_ARGS
  ...
  if("${3DMetricTools_VTK_RENDERING_BACKEND}" STREQUAL "OpenGL2")
    list(APPEND EXTERNAL_PROJECT_OPTIONAL_CMAKE_CACHE_ARGS
...
set(_git_tag)
if("${3DMetricTools_VTK_VERSION_MAJOR}" STREQUAL "7")
  set(_git_tag "43f6ee36f6e28c8347768bd97df4d767da6b4ce7")
elseif("${3DMetricTools_VTK_VERSION_MAJOR}" STREQUAL "8")
  set(_git_tag "75414fe171e5ae2ed6e4df608deb1d578d9ec7c3")
else()
  message(FATAL_ERROR "error: Unsupported 3DMetricTools_VTK_VERSION_MAJOR: ${3DMetricTools_VTK_VERSION_MAJOR}")
endif()
  ExternalProject_SetIfNotDefined(
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_CACHE_ARGS
      ...
      -DVTK_RENDERING_BACKEND:STRING=${3DMetricTools_VTK_RENDERING_BACKEND}
